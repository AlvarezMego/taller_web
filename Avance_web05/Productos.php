...
<nav>
    ...
    <Article class="Productos">
        ...
        <div class="caja " category="laptops"><div class="contenedor-modal"><img src="./imagenes/laptop8.webp"> <div class="overlay"><p> Laptop ASUS 15.6'Intel i5 10ma generación 8GB 512GB</p> <p>Precio: S/ 3099 </p><div class="btn-group"><a href="" class="btn btn-primary">Detalles</a><a href="" class="btn btn-success">Agregar</a></div></div></div></div>
        ...
        <div class="caja " category="audifonos"><div class="contenedor-modal"><img src="./imagenes/audi1.webp"> <div class="overlay"><p> Audífonos gamer inalámbricos Logitech G Series G733 negro con luz rgb LED</p> <p>Precio: S/591 </p><div class="btn-group"><a href="" class="btn btn-primary">Detalles</a><a href="" class="btn btn-success">Agregar</a></div></div></div></div>
        <div class="caja " category="audifonos"><div class="contenedor-modal"><img src="./imagenes/audi2.webp"> <div class="overlay"><p> Audífonos gamer HyperX Cloud Alpha black y red</p> <p>Precio: S/327 </p><div class="btn-group"><a href="" class="btn btn-primary">Detalles</a><a href="" class="btn btn-success">Agregar</a></div></div></div></div>
